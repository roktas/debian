...
apt-get -y purge ppp pppconfig pppoeconf || cry "apt-get purge exit code $? is suppressed"

# Delete oddities
apt-get -y purge popularity-contest || cry "apt-get purge exit code $? is suppressed"

# Remove APT files
apt-get -y autoremove --purge || cry "apt-get autoremove exit code $? is suppressed"
apt-get -y autoclean          || cry "apt-get autoclean exit code $? is suppressed"
apt-get -y clean              || cry "apt-get clean exit code $? is suppressed"
...
done || cry "truncating log files command exit code $? is suppressed"
